    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[85vh] mx-4 overflow-hidden shadow-2xl">
        ...
        <div className="px-6 py-5 overflow-y-auto max-h-[calc(85vh-80px)] space-y-6">
          ...
          <section>
            <h3 className="text-base font-semibold text-white mb-2 flex items-center gap-2">
              <span className="text-cyan-400">•</span> Team Quadrants (Card Badges)
            </h3>
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 rounded bg-cyan-500/20 text-cyan-400 border border-cyan-500/30 font-semibold">CS CHASER</span>
          ...
          <section>
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 rounded bg-slate-700/50 text-slate-400 border border-slate-600 font-semibold">STABLE</span>
                <span className="text-slate-400">Performing as expected. Hold position.</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="px-2 py-1 rounded bg-amber-500/20 text-amber-400 border border-amber-500/30 font-semibold">OVERHEATED</span>
