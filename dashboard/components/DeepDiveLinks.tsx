...
const quickLinks = [
  {
    ...
    description: 'Risk vs. performance scatter for institutional positioning',
  ...
  },
  {
    ...
    title: 'Asset Class Reports',
    description: 'Comprehensive market analysis for all 20 team portfolios',
  ...
  },
  {
    ...
    title: 'Alpha Signals',
    description: 'Identify mispriced assets with statistical edge',
